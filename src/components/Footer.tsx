        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="flex items-start gap-2 font-body text-muted-foreground">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#gallery" className="font-body text-muted-foreground hover:text-primary transition-colors">Gallery</a></li>
              ...
              <li><a href="#faq" className="font-body text-muted-foreground hover:text-primary transition-colors">FAQ</a></li>
              <li><a href="#booking" className="font-body text-muted-foreground hover:text-primary transition-colors">Book Now</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#services" className="font-body text-muted-foreground hover:text-primary transition-colors">Basic Clean</a></li>
            ...
            <h4 className="font-display text-lg text-foreground mb-4 mt-8">SERVICE AREA</h4>
